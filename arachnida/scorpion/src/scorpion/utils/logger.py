...
from scorpion.config import LOG_DATE_FORMAT, LOG_ENABLE_STDOUT, LOG_FILE 
from scorpion.config import LOG_DISABLED, LOG_LEVEL, LOG_FORMAT, TERMINAL_COLORS as C
